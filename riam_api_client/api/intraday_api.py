...
import six
# Model imports
from . import InlineResponse20068
from . import InlineResponse20069
from . import InlineResponse20071
from . import InlineResponse20072
from . import InlineResponse20070
...
class IntradayApi(object):
    ...
    def intraday_puntas_get_puntas(self, fecha, nemo, **kwargs):  # noqa: E501
        ...
        :rtype: InlineResponse20068 | multiprocessing.pool.ApplyResult
        """
    ...
    def intraday_transaccion_intraday_get(self, fecha, **kwargs):  # noqa: E501
        ...
        :return: InlineResponse20069
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: InlineResponse20069 | multiprocessing.pool.ApplyResult
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
    ...
    def intraday_valorizacion_intraday_calculadora(self, nemo, fecha, **kwargs):  # noqa: E501
        """Obtiene la valorización de un instrumento.  # noqa: E501

        Obtiene la valorización de un instrumento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.intraday_valorizacion_intraday_calculadora(nemo, fecha, async_req=True)
        >>> result = thread.get()
        ...
        :return: InlineResponse20071
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: InlineResponse20071 | multiprocessing.pool.ApplyResult
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.intraday_valorizacion_intraday_calculadora_with_http_info(nemo, fecha, **kwargs)  # noqa: E501
        else:
            (data) = self.intraday_valorizacion_intraday_calculadora_with_http_info(nemo, fecha, **kwargs)  # noqa: E501
            return data

    def intraday_valorizacion_intraday_calculadora_with_http_info(self, nemo, fecha, **kwargs):  # noqa: E501
        """Obtiene la valorización de un instrumento.  # noqa: E501

        Obtiene la valorización de un instrumento.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.intraday_valorizacion_intraday_calculadora_with_http_info(nemo, fecha, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method intraday_valorizacion_intraday_calculadora" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'nemo' is set
        if ('nemo' not in params or
                params['nemo'] is None):
            raise ValueError("Missing the required parameter `nemo` when calling `intraday_valorizacion_intraday_calculadora`")  # noqa: E501
        # verify the required parameter 'fecha' is set
        if ('fecha' not in params or
                params['fecha'] is None):
            raise ValueError("Missing the required parameter `fecha` when calling `intraday_valorizacion_intraday_calculadora`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/Outputs/Generic/Intraday/ValorizacionIntraday/calculadora', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def intraday_valorizacion_intraday_familia_get(self, fecha, familia, **kwargs):  # noqa: E501
        ...
        :param bool ultimo_remate: Si es 1, entrega solo la valorizacion del ultimo remate disponible de cada instrumento en vez de todos los remates del dia
        :return: InlineResponse20072
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: InlineResponse20072 | multiprocessing.pool.ApplyResult
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
    ...
    def intraday_valorizacion_intraday_familia_get_with_http_info(self, fecha, familia, **kwargs):  # noqa: E501
        ...
        all_params = ['fecha', 'familia', 'ultimo_remate']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'ultimo_remate' in params:
            query_params.append(('ultimoRemate', params['ultimo_remate']))  # noqa: E501
    ...
    def intraday_valorizacion_intraday_get(self, fecha, nemo, **kwargs):  # noqa: E501
        ...
        :param date fecha: Fecha a consultar (required)
        :param str nemo: Nemotécnico del instrumento a consultar (required)
        :param bool ultimo_remate: Si es 1, entrega solo la valorizacion del ultimo remate disponible en vez de todos los remates del dia
        :return: InlineResponse20070
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: InlineResponse20070 | multiprocessing.pool.ApplyResult
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
    ...
    def intraday_valorizacion_intraday_get_with_http_info(self, fecha, nemo, **kwargs):  # noqa: E501
        ...
        all_params = ['fecha', 'nemo', 'ultimo_remate']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')

...
class RFNCalculadoraApi(object):
    ...
    def r_fn_calculadora_calculadora_calcular_con_tir(self, nemo, fecha, tir, **kwargs):  # noqa: E501
        ...
        >>> thread = api.r_fn_calculadora_calculadora_calcular_con_tir(nemo, fecha, tir, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.r_fn_calculadora_calculadora_calcular_con_tir_with_http_info(nemo, fecha, tir, **kwargs)  # noqa: E501
        else:
            (data) = self.r_fn_calculadora_calculadora_calcular_con_tir_with_http_info(nemo, fecha, tir, **kwargs)  # noqa: E501
            return data

    def r_fn_calculadora_calculadora_calcular_con_tir_with_http_info(self, nemo, fecha, tir, **kwargs):  # noqa: E501
        """Obtiene la valorización de un instrumento para una tasa dada.  # noqa: E501

        Obtiene la valorización de un instrumento para una tasa dada.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.r_fn_calculadora_calculadora_calcular_con_tir_with_http_info(nemo, fecha, tir, async_req=True)
        >>> result = thread.get()

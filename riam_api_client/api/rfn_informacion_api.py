...
class RFNInformacionApi(object):
    ...
    def r_fn_informacion_informacion_get_all(self, familia, **kwargs):  # noqa: E501
        """Obtiene la información de Instrumentos vigentes para una familia.  # noqa: E501

        Obtiene la información de Instrumentos vigentes a la fecha de hoy para una familia.  La respuesta está paginada por instrumento (keyset sobre el nemo) para acotar el volumen: cada llamada devuelve a lo más {pageSize} instrumentos, ordenados por nemo ascendente. Para recorrer toda la familia, el cliente repite la llamada pasando en {nemoDesde} el mayor nemo recibido en la página anterior, y se detiene cuando una página vuelve vacía.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.r_fn_informacion_informacion_get_all(familia, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str familia: familia a consultar. Ejemplo: BE, BB, BS, BCU, etc (required)
        :param str nemo_desde: Paginación: nemo del último instrumento recibido en la página anterior. Se devuelven los instrumentos con nemo \"mayor\". Omitir para la primera página.
        :param int page_size: Cantidad de instrumentos por página (default 900, máximo 1000).
        :return: InlineResponse20038
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: InlineResponse20038 | multiprocessing.pool.ApplyResult
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.r_fn_informacion_informacion_get_all_with_http_info(familia, **kwargs)  # noqa: E501
        else:
            (data) = self.r_fn_informacion_informacion_get_all_with_http_info(familia, **kwargs)  # noqa: E501
            return data

    def r_fn_informacion_informacion_get_all_with_http_info(self, familia, **kwargs):  # noqa: E501
        """Obtiene la información de Instrumentos vigentes para una familia.  # noqa: E501

        Obtiene la información de Instrumentos vigentes a la fecha de hoy para una familia.  La respuesta está paginada por instrumento (keyset sobre el nemo) para acotar el volumen: cada llamada devuelve a lo más {pageSize} instrumentos, ordenados por nemo ascendente. Para recorrer toda la familia, el cliente repite la llamada pasando en {nemoDesde} el mayor nemo recibido en la página anterior, y se detiene cuando una página vuelve vacía.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.r_fn_informacion_informacion_get_all_with_http_info(familia, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['familia', 'nemo_desde', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method r_fn_informacion_informacion_get_all" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('familia' not in params or
            ...
            raise ValueError("Missing the required parameter `familia` when calling `r_fn_informacion_informacion_get_all`")  # noqa: E501
        ...
        if 'nemo_desde' in params:
            query_params.append(('nemoDesde', params['nemo_desde']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/Outputs/Generic/InformacionRF/Informacion/getAll', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def r_fn_informacion_informacion_get_familias(self, **kwargs):  # noqa: E501
        """Obtiene las familias de instrumentos disponibles.  # noqa: E501

        Obtiene las familias de instrumentos disponibles.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.r_fn_informacion_informacion_get_familias(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.r_fn_informacion_informacion_get_familias_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.r_fn_informacion_informacion_get_familias_with_http_info(**kwargs)  # noqa: E501
            return data

    def r_fn_informacion_informacion_get_familias_with_http_info(self, **kwargs):  # noqa: E501
        """Obtiene las familias de instrumentos disponibles.  # noqa: E501

        Obtiene las familias de instrumentos disponibles.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.r_fn_informacion_informacion_get_familias_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method r_fn_informacion_informacion_get_familias" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/Outputs/Generic/InformacionRF/Informacion/getFamilias', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def r_fn_informacion_riesgo_get(self, nemo, **kwargs):  # noqa: E501
        """Obtiene los cambios de clasificación de riesgo de uno o más instrumentos.  # noqa: E501

        Obtiene los cambios de clasificación de riesgo asignadas a uno o más instrumentos.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str nemo: Nemotécnico del instrumento a consultar. Se pueden especificar varios separando por 'pipes' (ASCII 124), máximo 20. IE: \"BACEN-A1 (required)
    ...
    def r_fn_informacion_riesgo_get_clasificadora(self, nemo, **kwargs):  # noqa: E501
        """Obtiene la clasificación vigente de cada clasificadora para uno o más instrumentos, para la fecha de hoy.  # noqa: E501

        Obtiene la clasificación vigente de cada clasificadora para uno o más instrumentos, para la fecha de hoy.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.r_fn_informacion_riesgo_get_clasificadora(nemo, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.r_fn_informacion_riesgo_get_clasificadora_with_http_info(nemo, **kwargs)  # noqa: E501
        else:
            (data) = self.r_fn_informacion_riesgo_get_clasificadora_with_http_info(nemo, **kwargs)  # noqa: E501
            return data

    def r_fn_informacion_riesgo_get_clasificadora_with_http_info(self, nemo, **kwargs):  # noqa: E501
        """Obtiene la clasificación vigente de cada clasificadora para uno o más instrumentos, para la fecha de hoy.  # noqa: E501

        Obtiene la clasificación vigente de cada clasificadora para uno o más instrumentos, para la fecha de hoy.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.r_fn_informacion_riesgo_get_clasificadora_with_http_info(nemo, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method r_fn_informacion_riesgo_get_clasificadora" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'nemo' is set
        if ('nemo' not in params or
                params['nemo'] is None):
            raise ValueError("Missing the required parameter `nemo` when calling `r_fn_informacion_riesgo_get_clasificadora`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/Outputs/Generic/InformacionRF/Riesgo/getClasificadora', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def r_fn_informacion_tabla_desarrollo_get_cambios_tabla_desarrollo(self, fecha, **kwargs):  # noqa: E501
        """Obtiene la lista de cambios de tablas de desarrollo de los últimos 90 días.  # noqa: E501

        Obtiene la lista de cambios de tablas de desarrollo de los últimos 90 días.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.r_fn_informacion_tabla_desarrollo_get_cambios_tabla_desarrollo(fecha, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.r_fn_informacion_tabla_desarrollo_get_cambios_tabla_desarrollo_with_http_info(fecha, **kwargs)  # noqa: E501
        else:
            (data) = self.r_fn_informacion_tabla_desarrollo_get_cambios_tabla_desarrollo_with_http_info(fecha, **kwargs)  # noqa: E501
            return data

    def r_fn_informacion_tabla_desarrollo_get_cambios_tabla_desarrollo_with_http_info(self, fecha, **kwargs):  # noqa: E501
        """Obtiene la lista de cambios de tablas de desarrollo de los últimos 90 días.  # noqa: E501

        Obtiene la lista de cambios de tablas de desarrollo de los últimos 90 días.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.r_fn_informacion_tabla_desarrollo_get_cambios_tabla_desarrollo_with_http_info(fecha, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method r_fn_informacion_tabla_desarrollo_get_cambios_tabla_desarrollo" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'fecha' is set
        if ('fecha' not in params or
                params['fecha'] is None):
            raise ValueError("Missing the required parameter `fecha` when calling `r_fn_informacion_tabla_desarrollo_get_cambios_tabla_desarrollo`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/Outputs/Generic/InformacionRF/TablaDesarrollo/getCambiosTablaDesarrollo', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,

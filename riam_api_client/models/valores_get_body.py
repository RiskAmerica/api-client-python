...
class ValoresGetBody(object):
    ...
    def __init__(self, plazo=None):  # noqa: E501
        """ValoresGetBody - a model defined in Swagger"""  # noqa: E501
        self._plazo = None
    ...
    @property
    def plazo(self):
        """Gets the plazo of this ValoresGetBody.  # noqa: E501
        Plazos a consultar (ARRAY(FLOAT))  # noqa: E501

        :return: The plazo of this ValoresGetBody.  # noqa: E501
        :rtype: list[float]
        """
        return self._plazo
    ...
    def plazo(self, plazo):
        """Sets the plazo of this ValoresGetBody.

        Plazos a consultar (ARRAY(FLOAT))  # noqa: E501

        :param plazo: The plazo of this ValoresGetBody.  # noqa: E501
        :type: list[float]
        """
        if plazo is None:
            raise ValueError("Invalid value for `plazo`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ValoresGetBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ValoresGetBody):
            return False
